...
public class PropertiesMapper
{
    ...
    public PropertiesMapper removeValue(final Object fromKey, final Object value) {
        if (this.values.containsKey(fromKey.toString())) {
            final List<String> val = this.values.get(fromKey.toString()).stream().filter(e -> !e.equals(value.toString())).collect((Collector<? super Object, ?, List<String>>)Collectors.toList());
            this.values.put(fromKey.toString(), val);
