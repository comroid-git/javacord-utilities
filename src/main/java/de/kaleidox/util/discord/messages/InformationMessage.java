...
public class InformationMessage
{
    ...
    public void refresh() {
        ...
        if (this.myMessage.get() != null) {
            this.myMessage.get().delete().thenRunAsync(() -> this.messageable.sendMessage(embed).thenAcceptAsync((Consumer)this.myMessage::set).exceptionally(ExceptionLogger.get(new Class[0]))).exceptionally(ExceptionLogger.get(new Class[0]));
        }
        else {
